            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex gap-2">
                    <div class="relative">
                        ...
                        <div class="absolute top-0 left-0 bg-white rounded-l-md px-2 h-full flex items-center border-2 border-gray-300"><span class="font-bold text-gray-500">R$</span></div>
                    </div>
                    @include('components.input', [
                        'id' => 'parcelas',
                        'placeholder' => '12',
